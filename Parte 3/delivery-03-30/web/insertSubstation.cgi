...
try:
    ...
    # Making query
    sql = """ INSERT INTO substation (gpslat,gpslong,locality,sname,saddress) VALUES (%s,%s,%s,%s,%s); """
    ...
    connection.commit()
    print('<b><h1 style="text-align:center;",class="a">Substation inserted successfully!</h1><b>')
