...
try:
	...
	print('<b><h1 style="text-align:center;",class="a">List of Element</h1><b>')
	print('<a href="index.cgi" class="button button2">Back to Main Page</a><br>')
	print('<a href="busbar.cgi" class="button button1">List BusBar</a><br>')
	print('<a href="transformer.cgi" class="button button3">List Transformer</a><br>')
	print('<a href="line.cgi" class="button button3">List Line</a><br>')


	#print('<h2>Insert Element</h2>')
	# The form will send the info needed for the SQL query
	#print('<form action="insertElement.cgi" method="post">')
	#print('<p>ID: <input type="text" name="id_e" required/></p>')
	...
	for row in result:
		...
		print('<td><a href="deleteElement.cgi?id={}">Delete</a></td>'.format(id))
		print('</tr>')
	print('</table>')
