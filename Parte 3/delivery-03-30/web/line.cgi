...
try:
	...
	print('<b><h1 style="text-align:center;",class="a">List of Line</h1><b>')
	print('<a href="index.cgi" class="button button2">Back to Main Page</a><br>')
	print('<h2>Insert Line</h2>')
	# The form will send the info needed for the SQL query
	print('<form action="insertLine.cgi" method="post">')
	print('<p>ID: <input type="text" name="id_l" required/></p>')
	print('<p>Impedance: <input type="text" name="impedance" required/></p>')
	print('<p>PBBID: <input type="text" name="pbbid" required/></p>')
	print('<p>SBBID: <input type="text" name="sbbid" required/></p>')
	...
	print('<tr><td>ID</td><td>Impedance</td><td>PBBID</td><td>SBBID</td></tr>')
	for row in result:
		print('<tr>')
		id = row[0]
		...
		print('<td><a href="deleteLine.cgi?id={}">Delete</a></td>'.format(id))
		print('</tr>')
	print('</table>')
