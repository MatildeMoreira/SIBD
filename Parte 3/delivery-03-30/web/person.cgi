...
try:
	...
	print('<b><h1 style="text-align:center;",class="a">List of Person</h1><b>')
	print('<a href="index.cgi" class="button button2">Back to Main Page</a><br>')
	print('<a href="supervisor.cgi" class="button button1">List Supervisors</a><br>')
	print('<a href="analyst.cgi" class="button button3">List Analysts</a><br>')
	...
	print('<tr><td>Name</td><td>Address</td><td>Phone</td><td>TaxID</td></tr>')
	for row in result:
		print('<tr>')
		name_person = row[0]
