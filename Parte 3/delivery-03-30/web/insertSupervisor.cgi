...
try:
    ...
    # Making query
    sql = """ INSERT INTO person (name,address,phone,taxid) VALUES (%s,%s,%s,%s); """
    data = (name,address,phone,taxID)
    cursor.execute(sql, data)
    connection.commit()
    sql = """ INSERT INTO supervisor (name,address) VALUES (%s,%s); """
    data = (name,address)
    cursor.execute(sql, data)
    connection.commit()

    print('<b><h1 style="text-align:center;",class="a">Supervisor inserted successfully!</h1><b>')
