...
try:
	...
	print('<b><h1 style="text-align:center;",class="a">List of Analyst</h1><b>')
	print('<a href="index.cgi" class="button button2">Back to Main Page</a><br>')
	print('<h2>Insert Analyst</h2>')
	# The form will send the info needed for the SQL query
	print('<form action="insertAnalyst.cgi" method="post">')
	print('<p>Name: <input type="text" name="name" required/></p>')
	print('<p>Address: <input type="text" step=any name="address" required/></p>')
	print('<p>Mobile Phone: <input type="number" step=any name="phone" required/></p>')
	print('<p>Substation TaxID: <input type="number" step=any name="taxID" required/></p>')
	...
	for row in result:
		...
		print('<td><a href="deleteAnalyst.cgi?name={}&address={}">Delete Person</a></td>'.format(name_person,address_person))
		print('</tr>')
	print('</table>')
