...
id_b = form.getvalue('id_b')
volt_b = form.getvalue('volt_b')
...
try:
    ...
    connection.commit()
    sql = """ INSERT INTO busbar (id,voltage) VALUES (%s,%s); """
    data = (id_b,volt_b)
    cursor.execute(sql, data)
    connection.commit()

    print('<b><h1 style="text-align:center;",class="a">BusBar inserted successfully!</h1><b>')
