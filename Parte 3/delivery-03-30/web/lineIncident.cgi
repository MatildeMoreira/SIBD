...
try:
	...
	print('<b><h1 style="text-align:center;",class="a">List of Line Incident</h1><b>')
	print('<a href="index.cgi" class="button button2">Back to Main Page</a><br>')

	print('<h2>Insert Line Incident</h2>')
	# The form will send the info needed for the SQL query
	print('<form action="insertLineIncident.cgi" method="post">')
	...
	print('<p>Point: <input type="text" name="point" required/></p>')
	...
	print('<tr><td>Instant</td><td>ID</td><td>Point</td></tr>')
	for row in result:
		print('<tr>')
		instant = row[0]
		id = row[1]
		...
		print('<td><a href="deleteLineIncident.cgi?instant={}&id={}">Delete</a></td>'.format(instant,id))
