<!-- This page shows the user the mobile phones of all employees -->
<?php
	session_start();
?>
...
<html>
	...
	<body>
		...
		<?php
			...
			$sql = "SELECT * FROM phone_number_employee";
            ...
            echo("<h1 style='text-align:center;'>Table of Mobile Phones:<em>employee</em></h1>");
            $raw = $_POST['type']['info'];
            $info = explode(":",$raw,2);           
