...
<html>
	...
	<body>
		...
		<?php
			...
			/* selection of all rows of the table employee */
			...
			if($result->rowCount() > 0){
				...
				echo("<h1 style='text-align:center;'>Table <em>employee</em></h1>");
				...
				echo("</table>");				
				echo("<button class='button button4' type='submit'>Update Employee</button>");
				echo("<br><br>");
				echo("<button class='button button3' formaction='mobilePhoneEmployee.php' type='submit'>Mobile Phones</button>");				
				echo('</form>');
			}
			else{
				echo("<h1 style='text-align:center'>Without Results at Employees Database!</h1>");
			}

			$connection = null;
		?>
		
		<form action="addEmployeeform.php" method = "post">
			<button class="button button1" type="submit">Insert Employee</button>
		</form>
